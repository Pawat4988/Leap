...
class DWaveTSPSolver(object):
    ...
    def add_variable(self):
        ...
        for i in range(n**2):
            for j in range(n**2):
                self.dqm.add_variable(2, label=(i,j))
            ...
            for i in range(n):
                for j in range(n):
                    ...
                    for case in range(2):
                        ...
                        self.dqm.set_quadratic_case(qubit_a,case,qubit_b,case,self.dqm.get_quadratic_case(qubit_a,case,qubit_b,case)+quadratic*gamma2)
        ...
        for t in range(n):
            for i in range(n):
                for case in range(2):
                    ...
                    gamma1 = 1
                    self.dqm.set_linear_case(qubit_a,case,self.dqm.get_linear_case(qubit_a,case)+gamma1*linear)
                for j in range(n):
                    for case in range(2):
                        qubit_b = t * n + j
                        if i!=j:
